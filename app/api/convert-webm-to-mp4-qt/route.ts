// app/api/convert-webm-to-mp4-qt/route.ts
// Clone of the main converter, used only by Shape of Harmony.
// Keeps exactly the same behavior as /api/convert-webm-to-mp4,
// so other toys are unaffected.
