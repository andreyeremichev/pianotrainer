...
export default function HomePage() {
  return (
    <main style={pageStyles.root}>
      ...
      {/* HOLIDAY MUSICAL POSTCARDS (TEMPORARY) */}
<section
  style={{
    maxWidth: 980,
  ...
  aria-label="Holiday musical postcards"
>
  <div style={{ textAlign: "center" }}>
    <h2 style={{ margin: 0, fontSize: 20, fontWeight: 900 }}>
      🎄 Holiday Musical Postcards
    </h2>
    <p style={{ margin: "6px 0 0", fontSize: 14, color: "#555", lineHeight: 1.55 }}>
      A small seasonal experiment: short interactive postcards for Christmas and New Year.
      Tap a preview to open the full postcard on MusicalToys.
    </p>
  </div>
  ...
  >
    {/* Xmas */}
    <Link
      href="https://musicaltoys.app/cards/postcard/xmas"
      aria-label="Open Christmas musical postcards on MusicalToys"
      style={{
        display: "grid",
        gap: 8,
        textDecoration: "none",
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "baseline" }}>
        <div style={{ fontWeight: 900 }}>Christmas Postcards</div>
        <div style={{ fontSize: 12, color: "#666" }}>Preview • Tap to open →</div>
      </div>
    </Link>

    {/* New Year */}
    <Link
      href="https://musicaltoys.app/cards/postcard/new-year"
      aria-label="Open New Year musical postcards on MusicalToys"
      style={{
        display: "grid",
        gap: 8,
        textDecoration: "none",
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "baseline" }}>
        <div style={{ fontWeight: 900 }}>New Year Postcards</div>
        <div style={{ fontSize: 12, color: "#666" }}>Preview • Tap to open →</div>
      </div>
    </Link>
  </div>
  ...
  <div style={{ display: "flex", justifyContent: "center" }}>
    <Link
      href="https://musicaltoys.app/cards"
      aria-label="Open all postcard sets on MusicalToys"
      style={{
        display: "inline-flex",
        alignItems: "center",
