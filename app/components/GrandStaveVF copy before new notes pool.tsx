...
type Props = {
  ...
  /** Optional clef override for the single rendered note (e.g. C4 on bass for Guide mode). */
  forceClef?: "treble" | "bass";
};
...
export default function GrandStaveVF({ qa = false, noteMidi = null, forceClef }: Props) {
...
`;
  ...
  useEffect(() => {
    ...
    if (typeof noteMidi === "number") {
      ...
      // Use override if provided; otherwise default to C4 boundary
      const clef: "treble" | "bass" = forceClef ?? (noteMidi < 60 ? "bass" : "treble");
